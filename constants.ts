...
export const WORK_ITEMS: WorkItem[] = [
  ...
  },
  {
    ...
    description: '一个完全可交互的加载动效设计与开发画廊。该项目专门针对未来主义、赛博朋克与科幻 HUD 视觉交互而设计。项目整合了 5 种不同的载入效果，包括用户指定的 ClassicLoader、ModifiedClassicLoader 极简对称双弧，以及由 React、Framer Motion 弹性物理引擎精心编写的量子核心反应堆、数据流解密矩阵以及全息 HUD 圆环。用户可以微调运动速度、在四大赛博色域之间无缝切换、并实时查看系统仿真控制台日志。',
    year: '2025',
    detailImages: [

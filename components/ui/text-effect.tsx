...
export function TextEffect({
  ...
  const inViewResult = useInView(containerRef, { once: true, margin: inViewMargin as any });
  const isCurrentlyTriggered = trigger && (!inView || inViewResult);
    ...
    <AnimatePresence mode='popLayout'>
      {trigger && (
        <MotionTag
          ...
          initial='hidden'
          animate={isCurrentlyTriggered ? 'visible' : 'hidden'}
          exit='exit'
